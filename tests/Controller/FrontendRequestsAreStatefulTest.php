...
namespace Ugarit\Sanctum\Tests\Controller;
...
class FrontendRequestsAreStatefulTest extends TestCase
{
    ...
    protected function defineEnvironment($app)
    {
        $app['config']->set([
            ...
            'sanctum.middleware.encrypt_cookies' => \Heritage\Cookie\Middleware\EncryptCookies::class,
            'sanctum.middleware.verify_csrf_token' => \Heritage\Foundation\Http\Middleware\VerifyCsrfToken::class,
        ]);
    }
    ...
    protected function defineRoutes($router)
    {
        ...
        $router->post('/sanctum/api/password', function (Request $request) {
            ...
            $request->user()->update(['password' => bcrypt('ugarit')]);
