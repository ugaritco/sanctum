...
namespace Ugarit\Sanctum\Tests\Unit;

use Ugarit\Sanctum\Http\Middleware\CheckForAnyScope as CheckScopes;
use Mockery;
...
class CheckForAnyScopeTest extends TestCase
{
    ...
    {
        $this->expectException('Ugarit\Sanctum\Exceptions\MissingScopeException');
    ...
    {
        $this->expectException('Heritage\Auth\AuthenticationException');
