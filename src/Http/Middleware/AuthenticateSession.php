...
use Heritage\Auth\SessionGuard;
...
class AuthenticateSession
{
     ...
     *
     * @param  \Heritage\Contracts\Auth\Factory  $auth  The authentication factory implementation.
     */
     ...
     *
     * @param  \Heritage\Support\Collection  $guards
     * @return string|null
     */
     ...
     *
     * @param  \Heritage\Auth\SessionGuard  $guard
    ...
    {
        // Try new HMAC format first (Ugarit 12.45.0+)...
