...
/**
 * @template TToken of \Ugarit\Sanctum\Contracts\HasAbilities = \Ugarit\Sanctum\PersonalAccessToken
 */
class Sanctum
{
    /**
     ...
     */
    public static $personalAccessTokenModel = 'Ugarit\\Sanctum\\PersonalAccessToken';
     ...
     *
     * @param  \Heritage\Contracts\Auth\Authenticatable|\Ugarit\Sanctum\HasApiTokens  $user
     * @param  array  $abilities
     * @param  string  $guard
     * @return \Heritage\Contracts\Auth\Authenticatable
     */
